...
const MODELS_BY_MAKE = {
  "BMW": ["1-Series","2-Series","3-Series","4-Series","5-Series","6-Series","7-Series","8-Series","M2","M3","M4","M5","M8","X1","X2","X3","X4","X5","X6","X7","Z4","i8"],
  "Ford": ["Bronco","EcoSport","Edge","Escape","Expedition","Explorer","F-150","F-250","Fiesta","Focus","Fusion","Mustang","Ranger","Taurus","Transit"],
  "Toyota": ["86","4Runner","Avalon","C-HR","Camry","Corolla","Corolla Cross","FJ Cruiser","Fortuner","Highlander","Hilux","Land Cruiser","Land Cruiser Prado","Prius","RAV-4","Sequoia","Sienna","Supra","Tacoma","Tundra","Yaris"],
};
...
const SUPPLEMENTARY_MODELS = {
  "Acura": ["ILX","Integra","MDX","NSX","RDX","TLX","ZDX"],
  "Audi": ["A3","A4","A5","A6","A7","A8","Q3","Q5","Q7","Q8","R8","e-tron"],
  ...
  "Kia": ["EV6","Forte","K5","Niro","Rio","Sorento","Soul","Sportage","Telluride"],
  ...
  "Mercedes-Benz": ["A-Class","C-Class","E-Class","G-Class","GLA","GLC","GLE","GLS","S-Class","SL"],
  "Mitsubishi": ["Eclipse Cross","Outlander","Pajero","L200"],
  "Nissan": ["Altima","Frontier","Murano","Pathfinder","Patrol","Rogue","Sentra","Sunny","X-Trail"],
  "Porsche": ["911","Cayenne","Macan","Panamera","Taycan"],
  "Subaru": ["Ascent","Crosstrek","Forester","Impreza","Legacy","Outback","WRX"],
  "Suzuki": ["Grand Vitara","Jimny","Swift","Vitara"],
  "Tesla": ["Cybertruck","Model 3","Model S","Model X","Model Y"],
  "Volkswagen": ["Atlas","Golf","Jetta","Passat","Polo","Tiguan"],
  "Volvo": ["S60","S90","XC40","XC60","XC90"],
};
Object.keys(SUPPLEMENTARY_MODELS).forEach(k => {
  if (!MODELS_BY_MAKE[k]) MODELS_BY_MAKE[k] = SUPPLEMENTARY_MODELS[k];
});

POPULAR_MAKES = Object.keys(MODELS_BY_MAKE).sort();
